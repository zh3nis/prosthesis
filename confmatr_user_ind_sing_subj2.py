...
def run_epoch(session, x, y, data, correct, total, loss, graph, train_op=None):
  print("graph operations")
  varname = "var_name/wout"
  #print(graph.get_operations())
  predictions = graph.get_operation_by_name(varname).outputs[0]
  all_predictions = []
  all_labels = []
...
#        sess, images_placeholder, labels_placeholder, valid_data, correct, total, loss)
    ...
    if (runme == 1):
      ...
      train_acc, train_loss = run_epoch(
          sess, images_placeholder, labels_placeholder, train_data, correct, total, loss, graph)
